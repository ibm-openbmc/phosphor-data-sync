...
{
  public:
    PosixSpawnFActions(const PosixSpawnFActions&) = delete;
    PosixSpawnFActions& operator=(const PosixSpawnFActions&) = delete;
    PosixSpawnFActions(PosixSpawnFActions&&) = delete;
    PosixSpawnFActions& operator=(PosixSpawnFActions&&) = delete;
